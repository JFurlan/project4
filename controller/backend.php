...
function addPost(){
    ...
    //require('view/backend/adminPost.php');
    header("Refresh: 2; URL=index.php?action=adminHome");
    throw new Exception('L\'article a bien été créé. <br><br>Vous allez être redirigé vers la Home de l\'administration.');
}
...
function updatePost(){
    ...
    //require('view/backend/adminPost.php');
    header("Refresh: 2; URL=index.php?action=adminHome");
    throw new Exception('Les informations de l\'article ont bien été modifiées. <br><br>Vous allez être redirigé vers la Home de l\'administration.');
}
...
function deletePost(){
    ...
    header("Refresh: 2; URL=index.php?action=adminHome");
    throw new Exception('Votre post a bien été supprimé. <br><br>Vous allez être redirigé vers la Home de l\'administration.');
}
    ...
    if(isset($_FILES['postImg'])){
        ...
        if(is_uploaded_file($tmp)){
            if ($type =="image/jpeg" || $type =="image/jpg" || $type =="image/png" && $size<= 1000000) {
                ...
                //echo "L'import de votre image a été rejeté. <br><br>Vérifiez son poids et/ou son type.";
            }
        }
    }
}
...
function deleteComment(){
    ...
    header("Refresh: 2; URL=index.php?action=adminComments");
